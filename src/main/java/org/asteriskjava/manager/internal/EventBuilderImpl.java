...
class EventBuilderImpl extends AbstractBuilder implements EventBuilder {
	...
	registerEventClass(NewSMS.class);
	registerEventClass(NewSMSConfirmation.class);
     ...
     * 
     * @param eventType
     *            the name of the event to register the class for. For example
     *            "Join".
     * @param clazz
     *            the event class to register, must extend {@link ManagerEvent}.
